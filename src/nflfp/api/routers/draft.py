...
@router.post(
    ...
    description=(
        ...
        "The consensus board driving the other seats is a stated behavioural "
        "model that has not been fitted to average-draft-position data or "
        "validated against real drafts. Its two parameters "
